...
export const objectMetadataList: { [contract in ObjectContractAddress | WallpaperContractAddress]: { [tokenId: number]: ObjectMetadata } } =
  {
    ...
    [WALLPAPER_CONTRACT_ADDRESS]: {
      ...
      6: {
        tokenId: 6,
        name: "Crossdirt",
        image_url: "https://www.arweave.net/kVkHSxG0P18v3AZFki1ZNB9TvL7ia8QOTmFhLxmNl7I?ext=png",
        json_url: "https://www.arweave.net/47sp4zF3pJeb1dUE2zpI8_QzfgiJLJcHDCsO4jO2odw",
        size: [8, 8],
        creator: "eBoy",
        maxClaimed: 999999999,
        price: 1,
      ...
      7: {
        tokenId: 7,
        name: "Grid",
        image_url: "https://www.arweave.net/EigUZqibHpn1g3CtV_J7v7O3a0yj4zpX6Xxf-dm4UCU?ext=png",
        json_url: "https://www.arweave.net/B10fSCh09iI_JcZhRuJ3XSpovWKBTm3CPoGrH353IeA",
        size: [8, 8],
        creator: "eBoy",
        maxClaimed: 999999999,
        price: 1,
      ...
      8: {
        tokenId: 8,
        name: "Highwaynevada",
        image_url: "https://www.arweave.net/TEr9MH_DazjmOK-32Oz2Uoxnb6mYTq-EhJjkxqEQwKw?ext=png",
        json_url: "https://www.arweave.net/2UEEz611j0maAZ5gzsm_ZCqORJ7feAHIKiD8T_QAxwM",
        size: [8, 8],
        creator: "eBoy",
        maxClaimed: 999999999,
        price: 1,
      ...
      9: {
        tokenId: 9,
        name: "Intersection",
        image_url: "https://www.arweave.net/clBr_fv29f0Bj9mxdM1TBCBgjeIJKr3OWgbxskuKsNI?ext=png",
        json_url: "https://www.arweave.net/Jk8Y6vn9tvDzubqFy-SiZ-lae_hNqFx5Vu2srwpdOwo",
        size: [8, 8],
        creator: "eBoy",
        maxClaimed: 999999999,
        price: 1,
