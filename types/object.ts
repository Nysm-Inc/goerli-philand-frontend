...
export const objectMetadataList: { [contract in ObjectContractAddress | WallpaperContractAddress]: { [tokenId: number]: ObjectMetadata } } =
  {
    [QUEST_OBJECT_CONTRACT_ADDRESS]: {
      ...
      24: {
        tokenId: 24,
        name: "Polygon Bridge",
        image_url: "https://www.arweave.net/pGDJ5vWh4G-3OrKT1lQqDbXBrAeoI1Wx-hPOj1WmE94?ext=png",
        json_url: "https://www.arweave.net/y8WUGb_4TMGDiO-b1Oodep_I0DmYE3Gn0R_H-HoOW5k",
        size: [2, 3, 3],
      ...
      31: {
        tokenId: 31,
        name: "Gas Truck",
        image_url: "https://www.arweave.net/bx1LxnVfIJWP01RKG0fXFxUmSWhzM6n-vBBpoUJRx60?ext=png",
        json_url: "https://www.arweave.net/JjKkjxm92dJCltbzjgaGGcpp7c_Aw4y-6SnMuvqoBho",
        size: [1, 3, 2],
        relatedProject: "Ethereum",
        creator: "ta2nb",
        maxClaimed: 999999999,
      ...
      32: {
        tokenId: 32,
        name: "Gas Station",
        image_url: "https://www.arweave.net/hhrRhgmaGSNiBAGfTtm0S0jxq7u-cCALG3l_JrtLWSY?ext=png",
        json_url: "https://www.arweave.net/t-xyAVQvaCTJs6Y3sEJqibSP2Pa4julEVB7Psr47oUs",
        size: [2, 3, 2],
        relatedProject: "Ethereum",
        creator: "ta2nb",
        maxClaimed: 999999999,
